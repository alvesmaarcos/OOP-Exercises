...
class Motorcycle {
    ...
    public Motorcycle(int power) {
        this.person = null; // a pessoa fica nula até que alguem suba na moto
        this.power = power;
        this.time = time;
    }
    ...
    public void honk(){
        StringBuilder tamanhoBuzina = new StringBuilder("P");
        for (int i = 0; i < this.power; i++) {
            tamanhoBuzina.append("e");
        }
        tamanhoBuzina.append("m");
        System.out.println(tamanhoBuzina);
    }
    ...
    public String toString(){
        ...
        if(person != null)
            ...
            pessoa = "(empty)";
        return String.format("power:%d, time:%d, person:%s", power, time, pessoa);
    }
}
